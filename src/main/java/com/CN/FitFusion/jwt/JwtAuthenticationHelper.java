...
public class JwtAuthenticationHelper {
	...
	public Claims getClaimByToken(String Token) {
		Claims claim=Jwts.parserBuilder().setSigningKey(SECRET_KEY.getBytes())
						.build().parseClaimsJws(Token).getBody();    //get body(claims) of token
